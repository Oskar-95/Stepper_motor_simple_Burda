...
#define DRIVER_0_ENABLE            GPIO_NUM_18   // L= disable motor output

#define VCC_IO                    GPIO_NUM_25  // L = reset všech driverů, H = provozní stav

#define DRIVERS_UART              UART_NUM_1
#define DRIVERS_UART_TXD          GPIO_NUM_27
#define DRIVERS_UART_RXD          GPIO_NUM_26
